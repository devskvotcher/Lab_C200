...
//////////////////////////////////////////////////////////////////////
	...
	//Виртуальная функция - это функция - член базового класса, 
	//которая может быть переопределена производным классом.
	
	//Чистая виртуальная функция - это функция - член базового класса, 
	//единственное объявление которой содержится в базовом классе 
	//и должно быть определено в производном классе, 
	//иначе производный класс также становится абстрактным.
	//
	// Чистая виртуальная функция-это виртуальная функция в C++,
	// для которой не нужно писать определение функции,
	// а только объявить ее.Она объявляется путем присвоения 0 
	// в объявлении.
	// Абстрактный класс-это класс в C++,
	// который имеет хотя бы одну чистую виртуальную функцию.
	//
	{
		Rect r(2, 4, 2, 4, Shape::BLACK);
		Shape* p = &r;
